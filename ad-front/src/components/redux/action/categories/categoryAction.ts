...
export const FETCH_CATEGORIES_FOR_PRODUCT_REQUEST = 'categories/fetchCategoriesForProductRequest';
export const FETCH_CATEGORIES_FOR_PRODUCT_SUCCESS = 'categories/fetchCategoriesForProductSuccess';
export const FETCH_CATEGORIES_FOR_PRODUCT_FAILURE = 'categories/fetchCategoriesForProductFailure';
...
export const fetchCategoriesForProductRequest = createAction(FETCH_CATEGORIES_FOR_PRODUCT_REQUEST);
export const fetchCategoriesForProductSuccess = createAction(FETCH_CATEGORIES_FOR_PRODUCT_SUCCESS);
export const fetchCategoriesForProductFailure = createAction(FETCH_CATEGORIES_FOR_PRODUCT_FAILURE);
...
export const fetchCategoriesForProduct = () => ({
  type: FETCH_CATEGORIES_FOR_PRODUCT_REQUEST
});
