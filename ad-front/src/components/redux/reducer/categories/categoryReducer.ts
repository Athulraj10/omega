import {
  ...
  FETCH_CATEGORIES_FOR_PRODUCT_SUCCESS,
  FETCH_CATEGORIES_FOR_PRODUCT_FAILURE,
...
interface CategoryState {
  ...
  categoriesForProduct: Category[];
  selectedCategory: Category | null;
  loading: boolean;
  activeCategoriesLoading: boolean;
  categoriesForProductLoading: boolean;
...
const initialState: CategoryState = {
  ...
  categoriesForProductLoading: false,
...
const categoryReducer = (state = initialState, action: any): CategoryState => {
  switch (action.type) {
    ...
    case FETCH_CATEGORIES_FOR_PRODUCT_REQUEST:
      return {
        ...state,
        categoriesForProductLoading: true,
        error: null,
      };

    case FETCH_CATEGORIES_FOR_PRODUCT_SUCCESS:
      return {
        ...state,
        categoriesForProductLoading: false,
        categoriesForProduct: action.payload,
        error: null,
      };

    case FETCH_CATEGORIES_FOR_PRODUCT_FAILURE:
      return {
        ...state,
        categoriesForProductLoading: false,
        error: action.payload,
