...
const MainCategoriesPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    icon: 'grid',
    parentCategory: '',
    isMainCategory: true, // Always true for main categories
    sortOrder: 0,
    status: '1',
    image: '',
    metaTitle: '',
  ...
  return (
    <div className="p-4">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Main Categories</h1>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <h2 className="text-xl font-bold mb-4">
              {showEditModal ? 'Edit Main Category' : 'Add New Main Category'}
            </h2>
