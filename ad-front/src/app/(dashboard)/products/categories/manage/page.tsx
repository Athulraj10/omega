...
const CategoryManagement = () => {
  ...
  const filteredCategories = categories.filter(category => {
    ...
    const matchesType = typeFilter === 'all' || 
                       (typeFilter === 'main' && category.isMainCategory) ||
                       (typeFilter === 'sub' && !category.isMainCategory);
    ...
    <div className="p-4">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <div className="flex flex-wrap gap-4 items-center justify-between">
          ...
          <button
            onClick={() => window.location.href = '/products/categories/add'}
                ...
                {!formData.isMainCategory && (
                  <div>
                    ...
                    >
                      ...
                      {categories.filter(c => c.isMainCategory).map(category => (
                    ...
                    {formData.parentCategory && (
                      <div className="mt-2 p-3 bg-gray-50 rounded-md">
                        <p className="text-sm text-gray-600">
                          <strong>Selected Parent:</strong> {getParentCategoryName(formData.parentCategory)}
                        </p>
                      </div>
                    )}
                  </div>
