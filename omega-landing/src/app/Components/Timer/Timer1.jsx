                    ...
                    <div className="container">
                        <div className="row gy-4 gx-134">
                            <div className="col-lg-6 d-flex align-items-center">
                                <div className="timer-thumb wow fadeInUp" data-wow-delay="0.3s" style={{ width: '350px', height: '600px' }}>
                                {/* <Image src="/assets/img/timer/timerThumb1_1.png" alt="img" width={250} height={150}  /> */}
